...
//  Home
//
//  Created by Sameh Mabrouk on 18/01/2022.
//
...
class MessageInputView: UIView {
    ...
    var buttonImage: UIImage = MessageInputView.getDefaultImage() {
        didSet {
    ...
    var viewBorderColor: UIColor = .gray {
        didSet {
    ...
    var viewBorderWidth: CGFloat = 0.5 {
        didSet {
            guard let mv = mainView else { return }
    ...
    var maxLines: CGFloat = 5.0
    
    var textViewTopInset: CGFloat = 0.0 {
        didSet {
    ...
    var textViewLeftInset: CGFloat = 8.0 {
        didSet {
            guard let tv = textView else { return }
