...
extension UICollectionView {
    ...
    func dequeueCell<T:UICollectionViewCell>(_ cell :T.Type, indexpath: IndexPath) -> T? {
        return dequeueReusableCell(withReuseIdentifier:  String.init(describing: cell), for: indexpath) as? T
    }

    func register<T: UICollectionViewCell>(_: T.Type, reuseIdentifier: String? = nil) {
        register(UINib.init(nibName: String(describing: T.self), bundle: Bundle.main), forCellWithReuseIdentifier: String(describing: T.self))
    }
}
