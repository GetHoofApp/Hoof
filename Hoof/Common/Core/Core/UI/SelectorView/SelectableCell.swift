...
public class ARSelectableCell: UICollectionViewCell {
    ...
    fileprivate var selectItem: SelectorItem?
    ...
    fileprivate func addViews() {
        ...
        NSLayoutConstraint.activate([self.selectButton.heightAnchor.constraint(equalToConstant: 18),
                                     self.selectButton.widthAnchor.constraint(equalToConstant: 18)])
    ...
    // MARK: - Confige Cell
    func configeCell(_ selectItem: SelectorItem?,
